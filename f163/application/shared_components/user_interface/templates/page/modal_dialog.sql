...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14626366137565426)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14626697766565426)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14626903786565426)
,p_page_template_id=>wwv_flow_imp.id(14626366137565426)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14627262976565426)
,p_page_template_id=>wwv_flow_imp.id(14626366137565426)
