...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14606082023565395)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14606351632565404)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14606638291565405)
,p_page_template_id=>wwv_flow_imp.id(14606082023565395)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14606926439565405)
,p_page_template_id=>wwv_flow_imp.id(14606082023565395)
