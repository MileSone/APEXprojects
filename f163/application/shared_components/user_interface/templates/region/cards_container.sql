...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14648753862565444)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14649014067565444)
,p_plug_template_id=>wwv_flow_imp.id(14648753862565444)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14649309142565444)
,p_plug_template_id=>wwv_flow_imp.id(14648753862565444)
,p_name=>'Sub Regions'
