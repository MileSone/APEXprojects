...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14660253300565452)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14660532583565452)
,p_plug_template_id=>wwv_flow_imp.id(14660253300565452)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14660839754565452)
,p_plug_template_id=>wwv_flow_imp.id(14660253300565452)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14661123814565452)
,p_plug_template_id=>wwv_flow_imp.id(14660253300565452)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14661448362565453)
,p_plug_template_id=>wwv_flow_imp.id(14660253300565452)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14661740754565453)
,p_plug_template_id=>wwv_flow_imp.id(14660253300565452)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14662033397565453)
,p_plug_template_id=>wwv_flow_imp.id(14660253300565452)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14662340442565453)
,p_plug_template_id=>wwv_flow_imp.id(14660253300565452)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14662671577565453)
,p_plug_template_id=>wwv_flow_imp.id(14660253300565452)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14662986410565454)
,p_plug_template_id=>wwv_flow_imp.id(14660253300565452)
,p_name=>'Sub Regions'
