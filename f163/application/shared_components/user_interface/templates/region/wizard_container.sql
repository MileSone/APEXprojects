...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14712984156565481)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14713216185565481)
,p_plug_template_id=>wwv_flow_imp.id(14712984156565481)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14713587851565481)
,p_plug_template_id=>wwv_flow_imp.id(14712984156565481)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14713837437565481)
,p_plug_template_id=>wwv_flow_imp.id(14712984156565481)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14714120057565482)
,p_plug_template_id=>wwv_flow_imp.id(14712984156565481)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14714437957565482)
,p_plug_template_id=>wwv_flow_imp.id(14712984156565481)
