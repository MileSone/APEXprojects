...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14693559153565470)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14693873752565471)
,p_plug_template_id=>wwv_flow_imp.id(14693559153565470)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14694150317565471)
,p_plug_template_id=>wwv_flow_imp.id(14693559153565470)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14694449957565471)
,p_plug_template_id=>wwv_flow_imp.id(14693559153565470)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14694738252565471)
,p_plug_template_id=>wwv_flow_imp.id(14693559153565470)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14695082117565471)
,p_plug_template_id=>wwv_flow_imp.id(14693559153565470)
,p_name=>'Sub Regions'
