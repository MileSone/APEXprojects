...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14636454517565432)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14636736362565437)
,p_plug_template_id=>wwv_flow_imp.id(14636454517565432)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14637081606565437)
,p_plug_template_id=>wwv_flow_imp.id(14636454517565432)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14637316722565437)
,p_plug_template_id=>wwv_flow_imp.id(14636454517565432)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14637693676565438)
,p_plug_template_id=>wwv_flow_imp.id(14636454517565432)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14637912501565438)
,p_plug_template_id=>wwv_flow_imp.id(14636454517565432)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14638238565565438)
,p_plug_template_id=>wwv_flow_imp.id(14636454517565432)
,p_name=>'Sub Regions'
