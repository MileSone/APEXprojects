...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14673981493565460)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14674209653565460)
,p_plug_template_id=>wwv_flow_imp.id(14673981493565460)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14674589998565460)
,p_plug_template_id=>wwv_flow_imp.id(14673981493565460)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14674834726565460)
,p_plug_template_id=>wwv_flow_imp.id(14673981493565460)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14675166428565460)
,p_plug_template_id=>wwv_flow_imp.id(14673981493565460)
,p_name=>'Sub Regions'
