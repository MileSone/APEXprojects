...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14691756409565469)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14692023968565469)
,p_plug_template_id=>wwv_flow_imp.id(14691756409565469)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14692392707565470)
,p_plug_template_id=>wwv_flow_imp.id(14691756409565469)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14692609673565470)
,p_plug_template_id=>wwv_flow_imp.id(14691756409565469)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14692942525565470)
,p_plug_template_id=>wwv_flow_imp.id(14691756409565469)
,p_name=>'Sub Regions'
