...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14669715348565457)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14670019001565457)
,p_plug_template_id=>wwv_flow_imp.id(14669715348565457)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14670316498565457)
,p_plug_template_id=>wwv_flow_imp.id(14669715348565457)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14670689483565457)
,p_plug_template_id=>wwv_flow_imp.id(14669715348565457)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14670939653565458)
,p_plug_template_id=>wwv_flow_imp.id(14669715348565457)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14671284370565458)
,p_plug_template_id=>wwv_flow_imp.id(14669715348565457)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14671517253565458)
,p_plug_template_id=>wwv_flow_imp.id(14669715348565457)
,p_name=>'Sub Regions'
