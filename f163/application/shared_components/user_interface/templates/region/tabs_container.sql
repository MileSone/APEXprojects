...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14705523422565477)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14705857981565477)
,p_plug_template_id=>wwv_flow_imp.id(14705523422565477)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14706191034565477)
,p_plug_template_id=>wwv_flow_imp.id(14705523422565477)
,p_name=>'Tabs'
